<?php if(!$indexing) { echo "<script>document.location.replace('./');</script>"; exit; } ?>
 <section>
<div class='dual-colmn'>
<div>
<h1><?php echo $LANG[13005]; ?></h1>

	<?php echo $LANG[12084]; ?><br /><br />
	<?php echo "Click no botão abaixo e converse com nossa equipe."; ?><br /><br />
	<a style='display:table;margin: 0 auto;' href='https://www.facebook.com/l2originsoficial' target='_blank' class='default dbig'><?php echo "Mensseger"; ?></a><br />
	...
	É alguém tentando se beneficiar de maneira ilícita."; ?><hr></div>
