...
##                   Configurações                       ##
###########################################################
$server_name = 'L2Aion'; // Nome do servidor
$server_chronicle = 'Interlude'; // Crônica do servidor
$server_url = 'www.l2aion.com'; // Digite exatamente o URL onde se encontra este site (exemplo: www.l2server.com)
...
$conMethod = 1; // 1 = MySQL, 2 = MySQLi, 3 = PDO-MySQL

$host = 'localhost'; // Endereço do host
$dbnm = 'l2jnetwork'; // Nome do banco
$user = 'root'; // Usuário
$pass = ''; // Senha
...
###########################################################
$admpass = 'Alti826516'; // Senha do painel admin


###########################################################
##               Configurações de e-mail                 ##
###########################################################
$admin_email = 'admin@l2aion.com'; // Endereço de e-mail que os jogadores podem utilizar para entrar em contato
$server_email = 'no-reply@l2aion.com'; // Seu endereço de e-mail utilizado para enviar e-mails automáticos (exemplo: nao-responda@seuservidor.com)
...
$captcha_register_on = 0; // Captcha no formulário de registro (1 = Sim | 0 = Não)
$captcha_cp_on = 0; // Captcha ao logar no painel de controle do usuário (1 = Sim | 0 = Não)
$captcha_forgotpass_on = 0; // Captcha ao enviar pedido de recuperação de conta para e-mail (1 = Sim | 0 = Não)
...
###########################################################
$cacheDelayMin = 3; // Intervalo em minutos que o cache de rankings e estatísticas são atualizados. Ex: se inserir '1' serão atualizados a cada 1 minuto
