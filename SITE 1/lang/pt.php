...
$LANG[10997] = "Sufixo";
$LANG[12977] = "Só será possível se cadastrar e efetuar o download a partir de:";
...
Armor: TT/DK/DY (SAME STATS)<br />
Weapon Grade-S/EPIC/IC/DY (SAME STATS)<br />
Jewels Boss<br />
Tattoo and Accessories<br />
Sub-Class free<br />
Noblesse party last hit barakiel<br />
Donates Does not influence balance<br />
Geodata and Pathnodes 100%<br />
Off-line Shop mode<br />
Auto Learn Skills<br />
Auto loot - Automatic pick up (except raid's drops)<br />
Wedding System<br />
Only 1 Clan per Ally <br />
Farm system: custom drop areas.<br />
Chaotic Zones.<br />
Events Automatics <br />
Clan Skills Selling - Double click in scroll for learn skills<br />
Argument STR,INT,WIT,MEN: 5% Chance<br />
Bishop authorized only in Party Zone<br />
...
<h2>Rates</h2>
Experience (EXP) x500<br />
Skill Points (SP) x500<br />
Adena x500<br />
Party: x2<br />
Drop: x10<br />
...
Max. Enchant Armor/Jewels +22<br />
Chance Scroll Normal: 50%<br />
Chance Scroll Blessed: 80%<br />
Chance Scroll Donate: 40%<br />

<hr />

<h2>Buffs</h2>
Buff Slot 36 + 4 (Divine Inspiration)<br />
All buffs in NPC <br />
Buff time 3 hours<br />
HS Buffs Free in NPC Buffer<br />
System PvP: Lose Buff in Chaotic Zone<br />


<hr />

<h2>Siege</h2>
Siege 7 in 7 Days<br />
Sieges Awarded<br />
Castle Active: Giran/Aden/Rune/Goddard<br />
Awards Castles: Giran and Aden<br />
Awards: 100 Ticket Varkas<br />
<hr />

<h2>Gameplay</h2>
All boss Chaotic Zone<br />
NO-BS in Area-PvP<br />
Party Zone Special Drops<br />
<hr />

<h2>Areas Farm</h2>
Varkas Silenos (x2) - Solo Zone<br />
Crypt of Disgrace (x3) - Party Zone (Chaotic)<br />

<hr />

<h2>Grand Olympiad</h2>
Olympiads Grade-S (No Custom)<br />
Max Enchant in Olympiads: +6<br />
Start Date: 23 Octuber<br />
Schedules: 18:00 until 23:59 PM UTC-3<br />
New periods on each 14 days.<br />
...
DDoS Protection by HyperFilter<br />
Geodata and Pathnodes working 100%<br />


<h2>Downloads and Registers</h2>
Dear players, Downloads and Registrations will be avaliable on October, 18 at 23:59 PM (UTC-3)<br />
