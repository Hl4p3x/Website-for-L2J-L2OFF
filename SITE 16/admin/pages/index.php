			...
			<div class="box">
				<div class="box-header with-border">
					...
					<div class="box-body">
						...
						Confira abaixo as últimas ações administrativas. Fique sempre atento!<br /><br />
						...
						<div style='display: table; margin: 0 auto; padding: 10px 0 0 0;'>
							<a class='btn btn-default' href='./?page=admin&module=logs'>Visualizar mais logs</a>
						</div>
		...
		<div class="col-md-6">
			<div class="box">
				<div class="box-header with-border">
					...
					<div class="box-body">
						Está precisando de ajuda ou possui dúvidas? Contate-nos!<br /><br />
						
						<div class="box box-widget widget-user">
							<div class="widget-user-header bg-aqua-active">
								<h3 class="widget-user-username">Atualstudio</h3>
								<h5 class="widget-user-desc">Desenvolvimento de Sites e Sistemas</h5>
								...
								<div class="row">
									<div class="col-sm-3 border-right">
										<div class="description-block">
											<a href="http://www.atualstudio.com/contato" class="btn btn-app" target="_blank"><i class="fa fa-comments"></i> Contato</a>
										</div>
									</div>
