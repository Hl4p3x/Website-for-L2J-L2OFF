...
if($funct['gamst9'] != 1) { fim($LANG[40003], 'ERROR', './'); }
?>
...
if($cacheDelayMin < 5) { $cacheDelayMin = 5; }
...
<div class='pddInner' style='padding-bottom:0;'>
	<?php echo $LANG[40063]."<br />".$LANG[30500]." <b>".date('d/m/Y', $updated)."</b> ".$LANG[30501]." <b>".date('H:i', $updated)."</b>."; ?><br /><br />
</div>
