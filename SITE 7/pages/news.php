...
if($newID != 'all') {
	...
	$newsImage = ((strlen(trim($new[0]['img'])) > 0) ? (file_exists($dir_newsimg.trim($new[0]['img'])) ? $dir_newsimg.trim($new[0]['img']) : 'imgs/nm/no-img-new.jpg') : 'imgs/nm/no-img-new.jpg');
	...
	if($totalNews > 0) {
		...
		include("private/includes/paginate.php");
