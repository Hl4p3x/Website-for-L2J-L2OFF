...
<div class='all <?php echo $language; ?>'>
	...
	<a href='./forum' class='forum-button' target='_blank'><span></span></a>
	...
	<div class='top-detail'></div>
		<div class='langs'>		<a href='?changelang=en' class='en' title='English' onclick="document.location.replace('./index.php?changelang=en&url=http://l2free.org%2F');return false;"><span></span></a>
		<a href='?changelang=pt' class='pt' title='Portugu&ecirc;s' onclick="document.location.replace('./index.php?changelang=pt&url=http://l2free.org%2F');return false;"><span></span></a>
		<a href='?changelang=es' class='es' title='Espa&ntilde;ol' onclick="document.location.replace('./index.php?changelang=es&url=http://l2free.org%2F');return false;"><span></span></a>
	</div>
	<div class='dual-buttons'>
		<a href='./?page=register' class='b1'><span></span></a>
		<a href='./?page=download' class='b2'><span></span></a>
	</div>
		<?php
			...
			?>
				...
				<div class='server-status on'>
					<?php echo ($gameStatus == 'on' ? "<div class='on'>ON</div>" : "<div class='s2off'><font color=#ff0000>OFF</font></div>"); ?></div>
                    <div class='players-online'><span class='s2'><?php echo intval($playersOnline*$fakePlayers); ?></span></div>
		<section>
			<div class='banners'>
