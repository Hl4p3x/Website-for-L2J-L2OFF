...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/../../../../../'.DIRGAL,
            'upload_url' => $this->get_full_url().'/../../../../../'.DIRGAL,
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function trim_file_name($name, $type, $index, $content_range) {
        ...
        $name = substr(time().md5(trim(basename(stripslashes($name)), ".\x00..\x20")), 0, 30);
        ...
        $removeJPEG = array('jpeg' => 'jpg');
        return strtr($name, $removeJPEG);
    }
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
			...
			$selectgal = mysql_query("SELECT * FROM ".DBNAME.".site_galeria ORDER BY g_position ASC", $conexao);
			...
			$insertfotodb = mysql_query("INSERT INTO ".DBNAME.".site_galeria (g_id, g_position) VALUES ('".$file->name."', '1')", $conexao);
			/* by airon fim */
            ...
            if ($file_size === $file->size) {
                ...
                if (!$content_range && $this->options['discard_aborted_uploads']) {
                    if(unlink($file_path)) {
						...
						$query = mysql_query("SELECT * FROM ".DBNAME.".site_galeria WHERE g_id = '".$file."' LIMIT 1", $conexao);
						if(mysql_num_rows($query) > 0) {
							mysql_query("DELETE FROM ".DBNAME.".site_galeria WHERE g_id = '".$file."' LIMIT 1", $conexao);
						}
